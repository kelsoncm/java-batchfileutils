...
public class LoteCampoDeserializadorValor  extends LoteCampoDeserializador  {

	@Override
	protected Object doDeserializar(char[] linha, ILoteCampo campo) {
		return LoteCampoUtils.subCharArrayToBigDecimal(linha, campo.getInicio()-1, campo.getFim()-1);
	}
